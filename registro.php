...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($tipo_usuario == 'profesor') {
        if ($codigo_docente === 'UNICALI_DOCENTE') {
            ...
            $mensaje = '<div style="background: rgba(244, 63, 94, 0.1); color: #fb7185; padding: 12px; border-radius: 10px; margin-bottom: 25px; font-size: 0.85rem; border: 1px solid rgba(244, 63, 114, 0.2);"><i class="fa-solid fa-triangle-exclamation" style="margin-right: 8px;"></i> CÃ³digo de docente incorrecto.</div>';
            $valido = false;
        }
    }
    ...
    if ($valido) {
        ...
        if ($stmt_check->get_result()->num_rows > 0) {
            $mensaje = '<div style="background: rgba(244, 63, 94, 0.1); color: #fb7185; padding: 12px; border-radius: 10px; margin-bottom: 25px; font-size: 0.85rem; border: 1px solid rgba(244, 63, 114, 0.2);"><i class="fa-solid fa-triangle-exclamation" style="margin-right: 8px;"></i> El correo ya estÃ¡ registrado.</div>';
        } else {
            ...
            if ($stmt->execute()) {
                ...
                $mensaje = '<div style="background: rgba(16, 185, 129, 0.1); color: #34d399; padding: 12px; border-radius: 10px; margin-bottom: 25px; font-size: 0.85rem; border: 1px solid rgba(16, 185, 129, 0.2);"><i class="fa-solid fa-circle-check" style="margin-right: 8px;"></i> Registro exitoso. Tu cÃ³digo estudiantil ha sido generado automÃ¡ticamente. <a href="login.php" style="color: var(--primary); font-weight: 600;">Inicia sesiÃ³n AquÃ­</a></div>';
            } else {
    ...
    <script>
        function toggleCodigo(val) {
            ...
            if (val === 'profesor') {
                ...
                // El código docente sí debe ser obligatorio para este rol
    ...
    <div class="login-container">
        ...
        <div class="glass-panel login-box fade-in" style="max-width: 480px;">
            <div class="logo-area" style="margin-bottom: 25px;">
                ...
                <h2 style="font-size: 1.8rem;">Ãšnete a Unicali Segura</h2>
                <p class="text-muted">Crea tu cuenta acadÃ©mica hoy</p>
            </div>
            ...
            <form method="POST" action="">
                <div class="input-group">
                    ...
                    <input type="text" name="nombre" class="input-field" placeholder="Ej. Juan PÃ©rez" required>
                </div>

                <div class="input-group">
                    <label class="input-label">CÃ©dula / IdentificaciÃ³n</label>
                ...
                <div class="input-group">
                    ...
                    <select name="tipo_usuario" class="input-field" onchange="toggleCodigo(this.value)"
                        ...
                        <option value="profesor">Profesor (Requiere CÃ³digo)</option>
                    </select>
                </div>

                <div id="estudiante-fields" class="fade-in">
                    <div class="input-group">
                        <label class="input-label">Programa AcadÃ©mico</label>
                        <select name="programa" class="input-field" required>
                            ...
                            <option value="IngenierÃ­a de Software">IngenierÃ­a de Software</option>
                            ...
                            <option value="ContadurÃ­a PÃºblica">ContadurÃ­a PÃºblica</option>
                ...
                <div id="codigo-area" class="input-group"
                    ...
                    <label class="input-label" style="color: var(--primary);">CÃ³digo de Acceso Docente</label>
                    <input type="password" name="codigo_docente" class="input-field"
                        placeholder="Clave de autorizaciÃ³n">
                </div>
            ...
            <p style="font-size: 0.9rem; color: var(--text-muted);">
                Â¿Ya eres parte de Unicali? <a href="login.php"
